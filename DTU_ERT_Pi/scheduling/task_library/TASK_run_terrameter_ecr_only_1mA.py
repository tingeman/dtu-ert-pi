...
@add_task
def run_terrameter_ecr_only_1mA(*args, boot_delay=None, **kwargs):
    cmd_file = 'command_ecr_only_1mA'
    power_off = True
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        run_terrameter_ecr_only_1mA(boot_delay=int(sys.argv[1]))
    else:
        run_terrameter_ecr_only_1mA()