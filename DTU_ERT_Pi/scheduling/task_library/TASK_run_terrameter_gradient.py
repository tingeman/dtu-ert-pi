...
@add_task
def run_terrameter_gradient(*args, boot_delay=None, **kwargs):
    cmd_file = 'command_2x32_gradient_ecr_1sec'
    power_off = True
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        run_terrameter_gradient(boot_delay=int(sys.argv[1]))
    else:
        run_terrameter_gradient()