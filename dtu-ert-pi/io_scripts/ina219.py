...
For generic use on linux system I2C bus

Modified from: https://github.com/chrisb2/pi_ina219

"""
import logging
import time
from math import trunc
#import Adafruit_GPIO.I2C as I2C   # Not useful for generic Linux system
import io_scripts.i2c as I2C
...
class INA219:
    ...
    def __init__(self, busnum, shunt_ohms, max_expected_amps=None,
                 address=__ADDRESS,
        ...
        self._i2c = I2C.get_i2c_device(address, busnum)
