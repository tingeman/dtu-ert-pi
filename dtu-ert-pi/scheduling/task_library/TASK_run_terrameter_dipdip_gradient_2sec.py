...
@add_task
def run_terrameter_dipdip_gradient_2sec(*args, boot_delay=None, **kwargs):
    power_off = True
    cmd_file = 'command_2x32_dipdip_ecr_2sec_no_upload'
    cmd_file2 = 'command_2x32_gradient_ecr_2sec'
...
if __name__ == '__main__':
    if len(sys.argv) >= 3:
        ...
        run_terrameter_dipdip_gradient_2sec(boot_delay=int(sys.argv[1]), boot_delay2=int(sys.argv[2]))
    elif len(sys.argv) >= 2:
        run_terrameter_dipdip_gradient_2sec(boot_delay=int(sys.argv[1]))
    else:
        run_terrameter_dipdip_gradient_2sec()