...
@add_task
def run_terrameter_dipdip(*args, boot_delay=None, **kwargs):
    cmd_file = 'command_2x32_dipdip_ecr_1sec'
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        run_terrameter_dipdip(boot_delay=int(sys.argv[1]))
    else:
        run_terrameter_dipdip()